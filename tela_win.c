...
void tela_win(ALLEGRO_DISPLAY* disp) {
	al_install_keyboard();	                                                       
    ...
    ALLEGRO_FONT* font = al_load_ttf_font("Pictures/minha_fonte.ttf", 170, 0);
	ALLEGRO_FONT* font2 = al_load_ttf_font("Pictures/minha_fonte.ttf", 50, 0);
    ALLEGRO_BITMAP *sprite_trofeu = al_load_bitmap("Sprites/trofeu.png");
    ...
    while(controle){																		
		...
		if (event.type == ALLEGRO_EVENT_TIMER){
            ...
            al_draw_scaled_bitmap(sprite_trofeu, 0,0,1024,1024, 300, 0, 512, 512, 0);

            al_draw_text(font, al_map_rgb(0, 255, 0), 560, 200, ALLEGRO_ALIGN_CENTER, "YOU WIN");
