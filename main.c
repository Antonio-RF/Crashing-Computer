//Compilação: gcc main.c cria_mundo.c entidades.c tela_game_over.c tela_pause.c theboss.c -o AS $(pkg-config --libs --cflags allegro-5 allegro_main-5 allegro_font-5 allegro_image-5 allegro_ttf-5 allegro_primitives-5)
